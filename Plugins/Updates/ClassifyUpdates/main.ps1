function Invoke-HtpPluginMain {
    ...
    $helperFile = Join-Path $downloads "QUHAIM-Classify-Updates.ps1"
...
'@
    ...
    return [PSCustomObject]@{
        "Tool" = "تصنيف التحديثات"
        "Status" = "تم فتح نافذة تصنيف التحديثات."
        "HelperScript" = $helperFile
        "Safety" = "هذه الأداة تصنف التحديثات فقط ولا تثبّت أي شيء."
    }
}
