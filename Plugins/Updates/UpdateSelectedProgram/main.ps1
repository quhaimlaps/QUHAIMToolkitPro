function Invoke-HtpPluginMain {
    ...
    $helperFile = Join-Path $downloads "QUHAIM-Update-Selected-Program.ps1"
...
'@
    ...
    return [PSCustomObject]@{
        "Tool" = "تحديث برنامج محدد"
        "Status" = "تم فتح نافذة اختيار التحديث. اختر رقم برنامج واحد فقط ثم اكتب YES للتأكيد."
        "HelperScript" = $helperFile
        "Safety" = "الأداة لا تحدث كل البرامج تلقائيًا."
    }
}
